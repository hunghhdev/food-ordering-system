package dev.hunghh.ordering.system.restaurant.service.dataaccess.restaurant.outbox.adapter;

import dev.hunghh.ordering.system.outbox.OutboxStatus;
import dev.hunghh.ordering.system.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import dev.hunghh.ordering.system.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import dev.hunghh.ordering.system.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import dev.hunghh.ordering.system.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import dev.hunghh.ordering.system.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
