package dev.hunghh.ordering.system.payment.service.messaging.listener.kafka;

import dev.hunghh.ordering.system.kafka.consumer.KafkaConsumer;
import dev.hunghh.ordering.system.kafka.order.avro.model.PaymentOrderStatus;
        ...
        messages.forEach(paymentRequestAvroModel -> {
            try {
                ...
                if (sqlException != null && sqlException.getSQLState() != null &&
                    ...
                    throw new PaymentApplicationServiceException("Throwing DataAccessException in PaymentRequestKafkaListener "
                    + e.getMessage(), e);
                }
