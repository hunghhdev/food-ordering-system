package dev.hunghh.ordering.system.customer.service.messaging.publisher.kafka;

import dev.hunghh.ordering.system.customer.service.domain.config.CustomerServiceConfigData;
import dev.hunghh.ordering.system.customer.service.domain.event.CustomerCreatedEvent;
import dev.hunghh.ordering.system.customer.service.domain.ports.output.message.publisher.CustomerMessagePublisher;
import dev.hunghh.ordering.system.customer.service.messaging.mapper.CustomerMessagingDataMapper;
import dev.hunghh.ordering.system.kafka.order.avro.model.CustomerAvroModel;
