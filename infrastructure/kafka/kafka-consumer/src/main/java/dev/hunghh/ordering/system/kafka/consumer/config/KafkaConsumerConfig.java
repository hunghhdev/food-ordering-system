package dev.hunghh.ordering.system.kafka.consumer.config;

import dev.hunghh.ordering.system.kafka.config.data.KafkaConfigData;
import dev.hunghh.ordering.system.kafka.config.data.KafkaConsumerConfigData;
