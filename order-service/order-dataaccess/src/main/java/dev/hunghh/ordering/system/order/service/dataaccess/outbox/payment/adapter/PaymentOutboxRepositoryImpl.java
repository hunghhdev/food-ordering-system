package dev.hunghh.ordering.system.order.service.dataaccess.outbox.payment.adapter;

import dev.hunghh.ordering.system.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import dev.hunghh.ordering.system.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import dev.hunghh.ordering.system.order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
...
public class PaymentOutboxRepositoryImpl implements PaymentOutboxRepository {
    ...
    public Optional<List<OrderPaymentOutboxMessage>> findByTypeAndOutboxStatusAndSagaStatus(String type,
        ...
        return Optional.of(paymentOutboxJpaRepository.findByTypeAndOutboxStatusAndSagaStatusIn(type,
                ...
                .orElseThrow(() -> new PaymentOutboxNotFoundException("Payment outbox object could not be found for" +
                        " saga type " + type))
                .stream()
