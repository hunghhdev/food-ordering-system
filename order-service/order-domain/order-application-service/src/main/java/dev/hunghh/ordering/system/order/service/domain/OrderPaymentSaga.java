...
import dev.hunghh.ordering.system.order.service.domain.outbox.scheduler.approval.ApprovalOutboxHelper;
import dev.hunghh.ordering.system.order.service.domain.outbox.scheduler.payment.PaymentOutboxHelper;
import dev.hunghh.ordering.system.outbox.OutboxStatus;
import dev.hunghh.ordering.system.saga.SagaStatus;
import dev.hunghh.ordering.system.saga.SagaStep;
...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public void rollback(PaymentResponse paymentResponse) {
        ...
        if (orderPaymentOutboxMessageResponse.isEmpty()) {
            log.info("An outbox message with saga id: {} is already roll backed!", paymentResponse.getPaymentId());
            return;
        }
